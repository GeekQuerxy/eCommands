...
class ClientDownload extends Command
{
    ...
    private $softs        = [
        ...
        [
            'name'      => 'ShadowsocksDWindows',
            'tagMethod' => 'github_release',
            'gitRepo'   => 'TheCGDF/SSD-Windows',
            'savePath'  => 'public/ssr-download/',
            'downloads' => [
                [
                    'sourceName' => 'SSD-%tagName%-x86.exe',
                    'saveName'   => 'ssd-win.exe',
                    'apkpureUrl' => ''
                ],
            ],
        ],
        ...
        [
            'name'      => 'ShadowsocksDAndroid',
            'tagMethod' => 'github_release',
            'gitRepo'   => 'TheCGDF/SSD-Android',
            'savePath'  => 'public/ssr-download/',
            'downloads' => [
                [
                    'sourceName' => 'SSD-%tagName%-mobile.apk',
                    'saveName'   => 'ssd-android.apk',
                    'apkpureUrl' => ''
                ],
            ],
        ],
